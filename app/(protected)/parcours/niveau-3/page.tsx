...
const lessons = Array.from({ length: 8 }, (_, i) => ({
  ...
  completed: false,
  unlocked: false,
  href: `/parcours/niveau-3/lecon-${i + 1}`
}))
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 pt-24 pb-16">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mb-8">
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-slate-700 p-8 shadow-xl shadow-black/20">
            <div className="flex items-start gap-4 mb-6">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-violet-400 to-purple-500 flex items-center justify-center flex-shrink-0">
        ...
        {/* Coming Soon Message */}
        <div className="bg-gradient-to-r from-violet-500/10 to-purple-500/10 border border-violet-500/30 rounded-xl p-8 text-center mb-8">
          ...
          <p className="text-gray-400 mb-4">
            Les leçons du Niveau 3 - Exploration seront bientôt disponibles.
            <br />
            Continue à pratiquer les niveaux précédents en attendant !
          </p>
          <Link
            href="/parcours"
            className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-violet-600 to-purple-600 text-white font-medium rounded-lg hover:opacity-90 transition-all"
          >
            Retour au parcours
