    ...
    <main className="min-h-screen">
      ...
      <section className="min-h-screen flex items-center px-12 py-20">
        <div className="max-w-4xl">
          ...
          >
            ...
            <p className="text-xl text-[#b4c6e7] mb-10 max-w-2xl leading-relaxed">
          ...
          >
            ...
            <div>
              <div className="text-4xl font-bold gradient-text mb-1">15min</div>
          ...
          {[
            ...
            >
              <GlassCard padding="lg">
                <p className="text-[#b4c6e7] mb-4 leading-relaxed">&ldquo;{testimonial.text}&rdquo;</p>
                <div>
                  <p className="font-semibold text-white">{testimonial.name}</p>
                  <p className="text-sm text-[#6b7fa8]">{testimonial.role}</p>
                </div>
              </GlassCard>
            </motion.div>
          ))}
      ...
      <section className="px-12 py-24">
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <GlassCard variant="elevated" padding="xl" className="max-w-3xl">
