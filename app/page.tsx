...
import { Piano, TrendingUp, Clock, Target, Music, Award, ArrowRight, BookOpen } from 'lucide-react'
    ...
    <main className="min-h-screen lg:pl-20">
      <div className="p-6 lg:p-8 max-w-[1800px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <GlassCard variant="elevated" padding="lg" className="md:col-span-2 lg:col-span-2">
            <div className="mb-6">
          ...
          <GlassCard variant="elevated" padding="xl" className="md:col-span-2 lg:col-span-4 text-center">
