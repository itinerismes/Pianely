...
export function AssistantWidget() {
  return (
    <div className="relative bg-gradient-to-br from-blue-500 via-purple-500 to-purple-600 rounded-2xl shadow-sm p-5 h-full overflow-hidden">
      ...
      <div className="relative z-10">
        <h2 className="text-white text-xl font-semibold mb-5">Que veux-tu travailler ?</h2>

        {/* Grid 2x2 */}
        <div className="grid grid-cols-2 gap-3">
          <button className="bg-white/20 backdrop-blur-sm rounded-xl p-4 hover:bg-white/30 transition flex flex-col items-center gap-2">
