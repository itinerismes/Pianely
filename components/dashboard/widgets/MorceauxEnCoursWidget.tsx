...
export function MorceauxEnCoursWidget({ morceaux, className }: MorceauxEnCoursWidgetProps) {
  return (
    <GlassCard variant="elevated" padding="md" className={className}>
      <div className="mb-4">
        <h2 className="text-lg font-semibold text-gray-900">Morceaux en cours</h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        {morceaux.map((morceau, index) => (
          <div
            key={index}
            className="p-4 rounded-xl bg-gradient-to-br from-violet-50 to-purple-50 border border-violet-100 hover:from-violet-100 hover:to-purple-100 transition-all"
          >
            <div className="flex items-center justify-between mb-3">
              <h3 className="font-semibold text-gray-900 text-sm">{morceau.titre}</h3>
